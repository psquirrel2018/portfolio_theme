...
<header class="header-type-2">
    <div class="container-fluid">
        ...
        <div id="project_filters_container" class="row ph-90">
            <div id="project-page" class="container col-xs-12">
                <ul class="nav navbar-nav navbar-right filter-nav" id="project_filters" style="">
                    <?php
                    $terms2 = get_terms('project_category');
                    $count = count($terms2);
